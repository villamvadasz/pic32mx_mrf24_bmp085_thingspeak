...
#define TICKS_PER_MILLISECOND  (1) // Internal core clock drives timer with 1:256 prescaler
#define TICKS_PER_SECOND  (1000) // Internal core clock drives timer with 1:256 prescaler

// Represents one second in Ticks
#define TICK_MILLISECONDS  ((uint64_t)TICKS_PER_MILLISECOND)
// Represents one second in Ticks
